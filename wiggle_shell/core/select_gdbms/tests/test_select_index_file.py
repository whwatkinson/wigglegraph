...
class TestRelationshipIndex:
    def test_create_new_relationship_index(
        ...
        test_ri_fp = TEST_GDBMS_FOLDER_PATH.joinpath(
        ...
        test_after = create_new_indexes_file(
            gdbms_name=gdbms_name, path_to_dbms_dir=TEST_GDBMS_FOLDER_PATH
        )
    ...
    def test_get_existing_relationship_index_file_path(self) -> None:
        exp_indexes_fp = TEST_GDBMS_FOLDER_PATH.joinpath(
        ...
        with pytest.raises(FileNotFoundError):
            get_existing_indexes_file_path(
                gdbms_name="NOT A rel index", path_to_dbms_dir=TEST_GDBMS_FOLDER_PATH
            )
