...
cases_for_test_nodes_rel_pattern = [
    ...
    pytest.param(
        """MAKE (left_node_handle:LeftNodeLabel{int: 1, str: '2', str2:"2_4", none: null)-[:]->(middle_node_label:MiddleNodeLabel { float: 3.14, list: [1, '2', "2_4", "3 4", 3.14, false], email: "harry@wg.net"});""",
        [
            {
                "left_node": "(left_node_handle:LeftNodeLabel{int: 1, str: '2', str2:\"2_4\", none: null)",
                "left_node_handle": "left_node_handle",
                "left_node_label": "LeftNodeLabel",
                "left_node_props": "{int: 1, str: '2', str2:\"2_4\", none: null",
                "left_middle_rel": "-[:]->",
                "left_middle_rel_handle": "",
                "left_middle_rel_label": "",
                "left_middle_rel_props": None,
                "middle_node": '(middle_node_label:MiddleNodeLabel { float: 3.14, list: [1, \'2\', "2_4", "3 4", 3.14, false], email: "harry@wg.net"})',
                "middle_node_handle": "middle_node_label",
                "middle_node_label": "MiddleNodeLabel",
                "middle_node_props": '{ float: 3.14, list: [1, \'2\', "2_4", "3 4", 3.14, false], email: "harry@wg.net"}',
                "middle_right_rel": None,
                "middle_right_rel_handle": None,
                "middle_right_rel_label": None,
                "middle_right_rel_props": None,
        ...
        [
            {
                ...
                "left_middle_rel": '-[lm:RELLM{int: 1, str: \'2\', str2:"2_4", float: 3.14, bool: false, none: null, list: [1, \'2\', "2_4", "3 4", 3.14]}]->',
                "left_middle_rel_handle": "lm",
                "left_middle_rel_label": "RELLM",
                "left_middle_rel_props": '{int: 1, str: \'2\', str2:"2_4", float: 3.14, bool: false, none: null, list: [1, \'2\', "2_4", "3 4", 3.14]}',
                "middle_node": '(middle_node_label:MiddleNodeLabel {int: 1, str: \'2\', str2:"2_4", float: 3.14, list: [1, \'2\', "2_4", "3 4", 3.14]})',
                "middle_node_handle": "middle_node_label",
                "middle_node_label": "MiddleNodeLabel",
                "middle_node_props": '{int: 1, str: \'2\', str2:"2_4", float: 3.14, list: [1, \'2\', "2_4", "3 4", 3.14]}',
                ...
                "right_node": '(right_node_label:RightNodeLabel {int: 1, str: \'2\', str2:"2_4", float: 3.14, bool: true, none: null, list: [1, \'2\', "2_4", "3 4", 3.14]} )',
                "right_node_handle": "right_node_label",
                "right_node_label": "RightNodeLabel",
                "right_node_props": '{int: 1, str: \'2\', str2:"2_4", float: 3.14, bool: true, none: null, list: [1, \'2\', "2_4", "3 4", 3.14]} ',
            }
        ],
        does_not_raise(),
